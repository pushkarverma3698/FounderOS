...
**The constraint is not supply.** 3,223 boards feed a pipeline that has stored 554 screened
...
| **More job sources** | 3,223 boards against 2 submitted applications. More supply is the most expensive way to avoid the actual problem |
