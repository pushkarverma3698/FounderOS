...
export const searchWeb = registerTool(
  tool(
    async ({ query, limit }) => {
  ...
  {
    departments: ["research", "marketing", "sales"],
    hitlGated: false,
    promptDescription: "external web search (news, company info, market data). Always cite URLs.",
  }
);
