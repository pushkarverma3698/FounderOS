...
- AI-native or dev-tool startups (seed–Series A)
- Pain: generic launch site; need credibility for funding or product launch
- Decision trigger: recent funding, product launch, or rebrand
...
- Mention the custom artifact you built for them (link to proof URL)
- One ask: 20-min call to discuss their launch experience
- Max 150 words; sign off: Pushkar, Turicks
