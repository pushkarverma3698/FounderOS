...
Built by [Pushkar Verma](https://www.linkedin.com/in/pushkarverma3698/) — building FounderOS to run [Turicks](https://turicks.com), an AI-native studio that ships working software in days, not decks. FounderOS is both the operator *and* the proof.
